...
<body>
        ...
        <div class="flex-row my-3 my-md-0">
          ...
          <a href="/profile/{{ auth()->user()->username }}" class="mr-2">
            <img title="My Profile" data-toggle="tooltip" data-placement="bottom"
              style="width: 32px; height: 32px; border-radius: 16px" src="{{ auth()->user()->getAvatar }}" />
          </a>
  ...
  @auth
    <div data-username='{{ auth()->user()->username }}' data-avatar='{{ auth()->user()->getAvatar }}'
      class="chat-wrapper shadow border-top border-left border-right" id="chat-wrapper">
